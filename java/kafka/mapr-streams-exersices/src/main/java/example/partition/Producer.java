...
public class Producer {
    ...
    public static void main(String[] argv){
        ...
        //Set DemoPartitioner as the Partitioner class
        configProperties.put("streams.partitioner.class",DemoPartitioner.class);
        ...
        while(!line.equals("exit")) {
            ...
            producer.send(rec, new Callback() {
                public void onCompletion(RecordMetadata recordMetadata, Exception e) {
                    System.out.println( "Message Sent Successfully Topic -> " + recordMetadata.topic() + " Partition -> "
